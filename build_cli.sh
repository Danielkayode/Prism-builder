...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/${VERSIONS_REPOSITORY}/refs/heads/main"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/${ASSETS_REPOSITORY}-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/${ASSETS_REPOSITORY}/releases"
fi
