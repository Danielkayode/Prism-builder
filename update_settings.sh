...
# 1. Inject the serverDownloadUrlTemplate (replaces add-remote-url.patch)
...
# 2. Inject Binary Name (replaces binary-name.patch)
# Targets the name property in the packaging task
